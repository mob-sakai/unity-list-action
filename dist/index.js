...
const version_js_1 = __nccwpck_require__(8836);
exports.version = {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.dntGlobalThis = exports.fetch = exports.Deno = void 0;
...
var node_fetch_2 = __nccwpck_require__(467);
Object.defineProperty(exports, "fetch", ({ enumerable: true, get: function () { return __importDefault(node_fetch_2).default; } }));
const dntGlobals = {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.scrapeBetaChangesets = exports.scrapeArchivedChangesets = exports.getUnityChangeset = void 0;
const dntShim = __importStar(__nccwpck_require__(2047));
const unityChangeset_js_1 = __nccwpck_require__(2758);
    ...
    switch (lifecycle) {
        ...
        case "b":
            return (await getUnityChangesetsFromUrl(UNITY_BETA_URL + version))
                .filter((c) => c.version === version)[0];
        default:
            throw Error(`The given life-cycle '${lifecycle}' (in ${version}) was not supported`);
    }
}
 ...
 */
async function scrapeArchivedChangesets() {
...
async function getUnityChangesetsFromUrl(url) {
    ...
    return match.map((m) => unityChangeset_js_1.UnityChangeset.createFromHref(m));
}
...
const { getUnityChangeset  } = __nccwpck_require__(1560);
